...
import type { DashboardDataSource, GaDashboardData, GscDashboardData } from "@/types";
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.25fr)]">
        <div className="rounded-[1.9rem] border border-border/70 bg-card/90 p-6 shadow-[0_30px_80px_-48px_rgba(15,23,42,0.38)] backdrop-blur-xl">
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <Badge variant={reviewStatusVariant(healthScore)}>
              {statusLabel}
            </Badge>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <StatCard
            ...
            status={hasLiveSearch ? undefined : "Waiting for GSC"}
          />
          <StatCard
            label="Impressions"
          ...
          <StatCard
            ...
            status={hasLiveAnalytics ? undefined : "Waiting for GA4"}
          />
        </div>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <div className="rounded-[1.8rem] border border-border/70 bg-card/90 p-5 shadow-[0_30px_80px_-48px_rgba(15,23,42,0.38)] backdrop-blur-xl">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-end gap-3">
                ...
                {hasLiveAnalytics ? (
                  ...
                  <Badge variant="outline">Waiting for GA4</Badge>
                )}
              </div>
          ...
          <div className="mt-4">
            <GAChart variant="sessions" daily={ga.daily} loading={gaLoading && ga.source !== "live"} />
          </div>
        </div>
