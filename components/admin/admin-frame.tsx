      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-72 shrink-0 border-r border-[#1F1F1F] bg-[#111111] px-5 py-6 lg:block">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-zinc-400">Platform operations, billing, cron health, and error visibility.</p>
          </div>
        ...
        <div className="flex min-h-screen min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 border-b border-[#1F1F1F] bg-[#0E0E0E]/95 backdrop-blur">
            <div className="flex items-center justify-between gap-4 px-4 py-4 sm:px-6">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#22C55E]">Ranula control room</p>
