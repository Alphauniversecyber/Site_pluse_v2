...
export async function renderAiReportPdf(input: PdfContext) {
  ...
  const footerText = `Report generated by ${brandName} using SitePulse monitoring. Next automated report: ${getNextReportDate(input)}. Questions? Reply to ${getReportContact(input)}.`;
