...
export const metadata: Metadata = buildPageMetadata({
  ...
  path: "/refund",
  keywords: [
    "SitePulse refund policy",
    "SEO SaaS refund policy",
    "Paddle refunds SitePulse",
    "agency software cancellation policy"
  ],
  imageAlt: "SitePulse refund policy"
});
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Refund Policy", item: `${PUBLIC_SITE_URL}/refund` }
        ]}
      />
      <LegalPageShell
        eyebrow="Legal"
