...
export const metadata: Metadata = buildPageMetadata({
  ...
  path: "/privacy",
  keywords: [
    "SitePulse privacy policy",
    "SEO audit software privacy",
    "agency reporting SaaS privacy",
    "data protection SitePulse"
  ],
  imageAlt: "SitePulse privacy policy"
});
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Privacy Policy", item: `${PUBLIC_SITE_URL}/privacy` }
        ]}
      />
      <LegalPageShell
        eyebrow="Legal"
