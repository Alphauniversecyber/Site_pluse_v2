...
export const metadata: Metadata = buildPageMetadata({
  ...
  path: "/terms",
  keywords: [
    "SitePulse terms of service",
    "SEO audit software terms",
    "agency reporting SaaS terms",
    "SitePulse billing terms"
  ],
  imageAlt: "SitePulse terms of service"
});
    ...
    <>
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "Terms of Service", item: `${PUBLIC_SITE_URL}/terms` }
        ]}
      />
      <LegalPageShell
        eyebrow="Legal"
